...
export function renderSuratMasihKuliah(ctx: DocumentContext): string {
  ...
  const isOrtuPns = ctx.is_ortu_pns === "ya";

  const ortuPnsSection = isOrtuPns
    ? `
<table class="info-table">
  <tr><td>Data Orang Tua</td><td>:</td><td></td></tr>
  <tr><td style="padding-left: 35px;">Nama</td><td>:</td><td>${placeholder(ctx.nama_ortu, "NAMA ORTU")}</td></tr>
  <tr><td style="padding-left: 35px;">NIP</td><td>:</td><td>${placeholder(ctx.nip_ortu, "NIP ORTU")}</td></tr>
  <tr><td style="padding-left: 35px;">Pangkat/golongan</td><td>:</td><td>${placeholder(ctx.pangkat_ortu, "PANGKAT ORTU")}</td></tr>
  <tr><td style="padding-left: 35px;">Instansi</td><td>:</td><td>${placeholder(ctx.instansi_ortu, "INSTANSI ORTU")}</td></tr>
</table>`
    : "";
...
<style>${PAGE_CSS}${HEADER_CSS}${FOOTER_CSS}${SIGNATURE_CSS}
  ...
  .info-table { width: 100%; border-collapse: collapse; margin-bottom: 15px; margin-left: 40px; }
  .info-table td { border: none; padding: 3px 0; vertical-align: top; }
  .catatan { font-size: 10pt; margin-top: 20px; }
</style>
</head>
<body>
<div class="page">
...
<p class="catatan">CATATAN : UNTUK MAHASISWA YANG ORANG TUANYA BUKAN PNS, DATA ORANG TUANYA TIDAK DITAMPILKAN</p>
