...
<body>
    <div class="page">
        ...
        <div class="title-section">
            <p class="title-text">SURAT REKOMENDASI</p>
        ...
        <p class="content-section">
            Mahasiswa tersebut di atas adalah benar-benar mahasiswa aktif pada Program Studi {{ $nama_prodi ?? '{nama_prodi}' }}, Fakultas Ushuluddin dan Adab, Universitas Islam Negeri Sultan Maulana Hasanuddin Banten pada Semester {{ $semester ?? '{semester}' }} Tahun Akademik {{ $tahun_akademik ?? '{tahun_akademik}' }}.
        </p>

        <p class="content-section">
            Dengan ini kami merekomendasikan mahasiswa tersebut untuk {{ $tujuan_rekomendasi ?? '{tujuan_rekomendasi}' }}.
        </p>
